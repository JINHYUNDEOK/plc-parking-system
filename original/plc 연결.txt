...
#define RELAY_PIN 6                 // PLC 전원을 제어할 릴레이 핀
#define X10_PIN 7                   // 첫 번째 서보모터 제어 신호 (X10)
#define X11_PIN 8                   // 두 번째 서보모터 제어 신호 (X11)
...
void setup() {
  ...
  pinMode(X10_PIN, OUTPUT);    // X10 출력 설정
  pinMode(X11_PIN, OUTPUT);    // X11 출력 설정
